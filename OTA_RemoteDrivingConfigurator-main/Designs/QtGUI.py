...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.SensorsComboBox.setItemText(0, _translate("MainWindow", "Speed_Digital"))
        self.SensorsComboBox.setItemText(1, _translate("MainWindow", "Temperature_Digital"))
        self.SensorsComboBox.setItemText(2, _translate("MainWindow", "Ultrasonic_Digital"))
        self.SensorsComboBox.setItemText(3, _translate("MainWindow", "Accelerometer_Digital"))
        self.SensorsComboBox.setItemText(0, _translate("MainWindow", "Speed_Physical"))
        self.SensorsComboBox.setItemText(1, _translate("MainWindow", "Temperature_Physical"))
        self.SensorsComboBox.setItemText(2, _translate("MainWindow", "Ultrasonic_Physical"))
        self.SensorsComboBox.setItemText(3, _translate("MainWindow", "Accelerometer_Physical"))
